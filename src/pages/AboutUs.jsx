...
const AboutUs = () => {
  return (
    <div className='pt-0 pb-2'>
      <div className='grid  h-full grid-cols-1 items-center justify-center lg:grid lg:grid-cols-2 lg:pt-20 lg:pl-40 lg:pb-60 pl-4 pl:h-screen'>
        <div className='images relative'>
        <img src={smile} alt="abou" className='smile' />
        <img src={mos} alt="abou" className='mores abosolute top-1/2 left-1/2' />
        </div>
        <div className='lg:pt-40 lg:pl-40 pt-10 pl-4 flex justify-center flex-col items-center'>
